...
<main>
    <section class="relative h-auto aspect-video w-full lg:h-[670px]">
        ...
        <div class="container flex-col hidden lg:flex h-full  justify-center relative z-20">
            <h1 class="text-white text-60 leading-66 font-medium">Tandheelkundig <br/> Centrum <br/> Peter van Houten</h1>
            <a class="text-black text-16 leading-20 font-medium h-5 px-3 bg-white  uppercase mt-3 w-fit flex justify-center items-center rounded-3xl" href="">
    ...
    <section class="bg-grey pb-5 lg:pb-10">
        <section class="lg:hidden">
            <div class="container pt-4 pb-5">
                                <h1 class="text-blue text-40 leading-46 font-medium">Tandheelkundig <br/> Centrum <br/> Peter van Houten</h1>
                        <a class="text-black text-16 leading-20 font-medium h-5 px-3 bg-white  uppercase mt-2 w-fit flex justify-center items-center rounded-3xl" href="">
                            <span class="mr-2"n>MAAK EEN AFSPRAAK</span>
                            <svg id="Afspraak" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="23.961" height="24" viewBox="0 0 23.961 24">
                            <defs>
                                <clipPath id="clip-path">
        ...
        <div class="container grid grid-cols-1 lg:grid-cols-2 mb-5 lg:mb-6">
            ...
            <div class="col-span-1 bg-white px-2 py-3 lg:px-5 lg:py-4">
                <h3 class="text-28 leading-32 lg:text-34 lg:leading-40 font-medium text-blue">Wil je direct inschrijven en een eerste afspraak maken? </h3>
                <a class="mt-3  lg:mt-2 flex w-fit bg-lightBlue rounded-3xl px-2 h-5 text-white items-center justify-center text-16 leading-20 font-medium" href="">
                    <span class="mr-2">INSCHRIJVEN</span>
        ...
        <div class="container grid grid-cols-1 lg:grid-cols-2">
            <div class="col-span-1 flex justify-center flex-col">
                <div>
                    <h3 class="text-blue font-medium text-34 leadimg-36">Over ons</h3>
                    <p class="max-w-[487px] text-16 leading-26 mb-3 mt-1 text-blue">Bij ons kunt u terecht voor tandheelkunde, orthodontistische behandelingen en mondhygiëne. Lorem Ipsum is slechts een proeftekst uit het drukkerij- en zetterijwezen van Lorem Ipsum bevatten. Lorem Ipsum is de standaard proeftekst.</p>
                    <a class="mt-[34px] flex w-fit bg-lightBlue rounded-3xl px-2 h-5 text-white items-center justify-center text-16 leading-20 font-medium" href="">
            ...
            <div class="col-span-1 hidden lg:block">
                <img class="w-full h-full object-cover" src="<?php echo get_template_directory_uri(); ?>/img/local/over-ons.png" alt="">
            </div>
        </div>
    </section>
     <img class="w-full h-full object-cover lg:hidden" src="<?php echo get_template_directory_uri(); ?>/img/local/over-ons.png" alt="">
    <section class="py-5 lg:pt-4 lg:pb-6">
        <div class="container flex justify-center flex-col">
            <h3 class="text-blue font-medium text-34 leadimg-36 text-left lg:text-center mb-2 lg:mb-2 flex lg:justify-center"><span class="hidden lg:flex">Onze &nbsp; </span> <span class="first-letter:uppercase lg:first-letter:lowercase">behandelingen</span> </h3>
            <div class="flex space-y-2 lg:space-y-0 lg:space-x-2 flex-col lg:flex-row lg:mx-auto">
                    <a class=" flex w-fit bg-grey rounded-3xl px-2 h-5 text-blue items-center justify-center text-16 leading-20 font-medium" href="">
                        <span class="mr-2">TANDHEELKUNDE</span>
                            <svg id="Pijl" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="14" viewBox="0 0 24 14">
                            <defs>
                                <clipPath id="clip-path">
                                <path id="Clip_2" data-name="Clip 2" d="M0,0H8V14H0Z" fill="none"/>
                            ...
                            <path id="Fill_4" data-name="Fill 4" d="M23,2H1A1,1,0,0,1,1,0H23a1,1,0,0,1,0,2" transform="translate(0 6)" fill="#01adff"/>
                                        ...
                                        <a class=" flex w-fit bg-grey rounded-3xl px-2 h-5 text-blue items-center justify-center text-16 leading-20 font-medium" href="">
                        <span class="mr-2">ORTHODONTIE</span>
                            <svg id="Pijl" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="14" viewBox="0 0 24 14">
                            <defs>
                                <clipPath id="clip-path">
                                <path id="Clip_2" data-name="Clip 2" d="M0,0H8V14H0Z" fill="none"/>
                            ...
                            <path id="Fill_4" data-name="Fill 4" d="M23,2H1A1,1,0,0,1,1,0H23a1,1,0,0,1,0,2" transform="translate(0 6)" fill="#01adff"/>
                                        ...
                                        <a class=" flex w-fit bg-grey rounded-3xl px-2 h-5 text-blue items-center justify-center text-16 leading-20 font-medium" href="">
                        <span class="mr-2">MONDHYGIËNE</span>
                            <svg id="Pijl" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="14" viewBox="0 0 24 14">
                            <defs>
                                <clipPath id="clip-path">
                                <path id="Clip_2" data-name="Clip 2" d="M0,0H8V14H0Z" fill="none"/>
